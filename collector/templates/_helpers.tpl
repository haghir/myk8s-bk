...
{{- printf "%s-storage-data" (include "collector.fullname" .) -}}
{{- end -}}

{{/*
Create the name of the backup storage
*/}}
{{- define "collector.storages.backup.name" }}
{{- printf "%s-storage-backup" (include "collector.fullname" .) -}}
{{- end -}}
